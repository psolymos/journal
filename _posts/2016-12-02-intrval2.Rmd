...
So what is new in this version? Some of the inconsistencies in the 1st CRAN release have been cleaned up, and a GitHub [issue](https://github.com/psolymos/intrval/issues/6) by [@mgacc0](https://github.com/mgacc0) pushed me real hard to implement all the 16 
...
Interval 1:  | Int. 2: `[]` | Int. 2: `[)` | Int. 2: `(]` | Int. 2: `()`
-----------------|--------------|--------------|--------------|--------------
`[]` | `%[]o[]%`    | `%[]o[)%`    | `%[]o(]%`    | `%[]o()%`
`[)` | `%[)o[]%`    | `%[)o[)%`    | `%[)o(]%`    | `%[)o()%`
`(]` | `%(]o[]%`    | `%(]o[)%`    | `%(]o(]%`    | `%(]o()%`
...
Please leave a comment or use the [issue tracker](https://github.com/psolymos/intrval/issues)
