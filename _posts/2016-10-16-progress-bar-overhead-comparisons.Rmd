...
As a testament to my obsession of progress bars in R, here is 
...
with number of iterations when using based `lapply`
...
for choosing one over the other. This is good news,
and another argument for using progress bar
because its usefulness far outweighs the minimal (<2 seconds) overhead cost. 
